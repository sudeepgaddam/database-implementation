...
class MyQueryRunner:public QueryRunner
{
    QueryPlanNode *root;    
    int noofPipes;        
...
public:    
    ...
    Compiler(Parser *_pi, Optimizer *_oi,QueryRunner *_qi,Catalog *_myCatalog):pi(_pi),oi(_oi),qi(_qi),myCatalog(_myCatalog)
    {
